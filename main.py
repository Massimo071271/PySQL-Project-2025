...
class MainApp:
    ...
    def search_by_release_year(self) -> None:
        ...
        release_year: str = input("Enter the release year: ").strip()
    ...
    def search_by_category(self) -> None:
        ...
        category_number: str = input("Enter the category number: ").strip()
    ...
    def search_by_price(self) -> None:
        ...
        price: str = input("Enter the ticket price from the list: ").strip()
        try:
    ...
    def search_by_rating(self) -> None:
        ...
        rating: str = input("Enter the rating from the list: ").strip()
